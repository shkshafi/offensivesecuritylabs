    ...
    public function run(): void
    {
        ...
        $notifications = [
            [
                ...
                'data' => [
                    'title' => 'Recon sweep completed',
                    'message' => 'Nmap scan finished successfully for 192.168.1.0/24 subnet. 12 active hosts discovered.',
                    'category' => 'system',
                    'icon' => 'server',
                    'action_url' => route('recon-agent'),
                    'action_label' => 'View Hosts',
                ],
                'read_at' => null,
            ...
            [
                ...
                'data' => [
                    ...
                    'category' => 'general',
                    'icon' => 'file-text',
                    'action_url' => route('report-creator'),
